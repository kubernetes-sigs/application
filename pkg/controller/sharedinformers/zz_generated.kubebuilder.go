...
import (
	...
	"github.com/kubernetes-sigs/apps_application/pkg/client/informers_generated/externalversions"
...
func (si *SharedInformers) startInformers(shutdown <-chan struct{}) {
	go si.Factory.Application().V1alpha1().Applications().Informer().Run(shutdown)
}
